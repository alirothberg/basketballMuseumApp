//
//  ARBasketballGameViewController.swift
//  Duke Basketball Museum
//
//  Created by Caleb Getahun on 7/28/20.
...
class ARBasketballGame: UIViewController, ARSCNViewDelegate {
    ...
    func registerGestureRecognizer(){
        ...
        sceneView.addGestureRecognizer(upSwipe)
...
//        sceneView.addGestureRecognizer(tap)
    ...
    @objc func handleSwipe(_ gestureRecognizer: UISwipeGestureRecognizer) {
        ...
        if gestureRecognizer.direction == .up {
            ...
            let userForce:Float = 7
            ballNode.physicsBody?.applyForce(SCNVector3(x: cameraPosition.x * userForce, y: cameraPosition.y * userForce, z: cameraPosition.z*userForce), asImpulse: true)
...
//    }
    ...
    func addBackboard(){
        guard let backboardScene = SCNScene(named: "art.scnassets/ARGame/arts/hoop.scn") else {
            return
        }
